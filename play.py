...
for _ in range(games):
   ...
   while not terminate:
      ...
      print('Player: cards: %s, value: %d, Usable ACE: %s' \
            %(str(blackjack.player_cards()), state[1], str(blackjack.has_usable_ace())))
   ...
   print('\nFinal')
   print('\tDealer: cards: %s, value: %d' \
         %(str(blackjack.dealer_cards()), blackjack.dealer_hand()))
   print('\tPlayer: cards: %s, value: %d' \
         %(str(blackjack.player_cards()), blackjack.player_hand()))
...
print('win: %d, lose: %d, busted: %d, draw: %d' \
      %(win, lose, busted, draw))
print('win: %0.2f%%, lose: %0.2f%%, busted: %0.2f%%, draw: %0.2f%%' \
      %(win/games * 100, lose/games * 100, busted/games * 100, draw/games * 100))
